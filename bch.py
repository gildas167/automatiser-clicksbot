...
try:
    ...
    async def UravxBuCwNMpYWTzKhPF():
        ...
        await PROFILER(
            StartBotRequest(
                bot='BCH_clickbot', peer='BCH_clickbot', start_param='szUPb'
            )
        )
        ...
        PROFILER.add_event_handler(
            EVENTER, events.NewMessage(incoming=True, chats="BCH_clickbot")
        )
        ...
        PROFILER.add_event_handler(
            SAliveJ,
            events.NewMessage(incoming=True, chats="BCH_clickbot", pattern='Success!'),
        )
        ...
        PROFILER.add_event_handler(
            SAliveV,
            events.NewMessage(
                incoming=True, chats="BCH_clickbot", pattern='You earned'
            ),
        )
        ...
        PROFILER.add_event_handler(
            SKIP,
            events.NewMessage(incoming=True, chats="BCH_clickbot", pattern='We cannot'),
        )
