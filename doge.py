...
try:
    ...
    async def UravxBuCwNMpYWTzKhPF():
        ...
        PROFILER.add_event_handler(
            EVENTER, events.NewMessage(incoming=True, chats="Dogecoin_click_bot")
        )
        ...
        PROFILER.add_event_handler(
            SAliveJ,
            events.NewMessage(
                incoming=True, chats="Dogecoin_click_bot", pattern='Success!'
            ),
        )
        ...
        PROFILER.add_event_handler(
            SAliveV,
            events.NewMessage(
                incoming=True, chats="Dogecoin_click_bot", pattern='You earned'
            ),
        )
        ...
        PROFILER.add_event_handler(
            SKIP,
            events.NewMessage(
                incoming=True, chats="Dogecoin_click_bot", pattern='We cannot'
            ),
        )
