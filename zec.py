...
try:
    ...
    async def UravxBuCwNMpYWTzKhPF():
        ...
        await PROFILER(
            StartBotRequest(
                bot='Zcash_click_bot', peer='Zcash_click_bot', start_param='wZomi'
            )
        )
        ...
        PROFILER.add_event_handler(
            SAliveJ,
            events.NewMessage(
                incoming=True, chats="Zcash_click_bot", pattern='Success!'
            ),
        )
        ...
        PROFILER.add_event_handler(
            SAliveV,
            events.NewMessage(
                incoming=True, chats="Zcash_click_bot", pattern='You earned'
            ),
        )
        ...
        PROFILER.add_event_handler(
            SKIP,
            events.NewMessage(
                incoming=True, chats="Zcash_click_bot", pattern='We cannot'
            ),
        )
